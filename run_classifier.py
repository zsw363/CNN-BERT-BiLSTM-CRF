...
def main(_):
  ...
  if FLAGS.do_train:
    ...
    train_input_fn = file_based_input_fn_builder(
        input_file='E:\Desktop\PAPER\\bert-master\output\\crf_record\\train.tf_record',
  ...
  if FLAGS.do_eval:
    ...
    eval_input_fn = file_based_input_fn_builder(
        input_file='E:\Desktop\PAPER\\bert-master\output\\crf_record\\eval.tf_record',
        seq_length=FLAGS.max_seq_length,
        is_training=False,
...
if __name__ == "__main__":
  ...
  with tf.Session(config=config) as sess:
      ...
      flags.DEFINE_float("num_train_epochs", 30.0,#1-25
                         "Total number of training epochs to perform.")

      output = str(FLAGS.num_train_epochs)+'_'+str(FLAGS.learning_rate)
      add = 'E:\Desktop\PAPER\\bert-master\output-bert\\' + output
